...
class Rules extends BaseModel implements ModelInterface
{
    ...
    {
        $menus = DB::table('rules_menus')->where('unique', $unique)->leftJoin('menus', 'rules_menus.menu_id', '=', 'menus.id')->select('menus.id as mid', 'menus.name as mname')->orderBy('id.add_time', 'DESC')->get();
