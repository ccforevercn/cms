...
class MessagesInsertRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'index' =>  'bail|required|integer|min:0|max:1',
            'hot' =>  'bail|required|integer|min:0|max:1',
            'release' =>  'bail|required|integer|min:0|max:1',
            'update_time' => 'bail|required|integer|max:2147483647',
            'release_time' => 'bail|required|integer|max:2147483647',
