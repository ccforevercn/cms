  ...
  <div class="app-container">
    <el-row :gutter="24">
      <el-form :model="where" @submit.native.prevent>
        <el-col :span="8"><el-form-item label="账号"><el-input class="where-username" v-model="where.username" @change="setWhereUserName"></el-input></el-form-item></el-col>
      </el-form>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" :before-close="dialogBeforeClosed" width="60%" center>
      <el-form class="edit-dialog-form">
        ...
        <el-form-item label="管理员名称">
          <el-input v-model="editInfo.real_name"></el-input>
        </el-form-item>
