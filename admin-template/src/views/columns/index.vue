      ...
      <el-form :model="where" @submit.native.prevent>
        <el-col :span="16">
          <el-form-item label="父级栏目">
            <el-select v-model="where.parent_id" placeholder="请选择父级栏目" @change="setWhereParentId">
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" :before-close="dialogBeforeClosed" width="60%" center>
      <el-form class="edit-dialog-form">
        ...
        <el-form-item label="页面">
          <el-input v-show="renderType === false" v-model="editInfo.page" type="url" />
          <el-select v-show="renderType === true" v-model="editInfo.page" placeholder="页面" filterable>
