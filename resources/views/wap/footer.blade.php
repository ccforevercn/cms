<footer class="v2_footer">
    <section class="v2-inner v2-ac">
        ...
        <div class="v2_footer_text col-sm-6 v2-ac">
            ...
            <p>电话：{{ $public['configs']['zy_cms_service_phone'] }} {{ $public['configs']['zy_cms_service_tel'] }} QQ:{{ $public['configs']['zy_cms_service_qq'] }} Email:{{ $public['configs']['zy_cms_service_email'] }}</p>
